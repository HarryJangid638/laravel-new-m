        ...
        <div class="authentication-inner py-6">
            ...
            <div class="card p-md-7 p-1">
                ...
                <div class="card-body mt-1">
                    ...
                    {!! html()->form('POST', route('admin.password.email'))->id('formAuthentication')->class('mb-5')->open() !!}
                        ...
                        {!! html()->button('Send Reset Link')->type('submit')->class('btn btn-primary d-grid w-100 mb-5') !!}
                    {!! html()->form()->close() !!}
            ...
            <!-- /Forgot Password -->
            <img alt="mask" src="{{ asset('assets/img/illustrations/auth-basic-forgot-password-mask-light.png') }}" class="authentication-image d-none d-lg-block" data-app-light-img="illustrations/auth-basic-forgot-password-mask-light.png" data-app-dark-img="illustrations/auth-basic-forgot-password-mask-dark.png">
        </div>
    </div>
</div>
<!-- / Content -->

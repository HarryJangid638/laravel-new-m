<x-layout.admin title="Edit Category">
    <section class="content-main">
        ...
        <div class="card">
            <div class="card-body">
                {!! html()->modelForm($category, 'PUT', route('admin.categories.update', $category->id))->id('category-edit-form')->open() !!}
                    <div class="row">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                {!! html()->checkbox('status', $category->status === 'active')
                                    ->id('category-status')
    ...
    <script>
        ...
        {
            $('#category-edit-form').submit(async function(e)
            {
                e.preventDefault();
                ...
                if(result.success)
                {
                    toasterAlert('success', result.message || 'Category updated successfully');

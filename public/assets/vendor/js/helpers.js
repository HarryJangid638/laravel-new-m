!function(e, t) {
    ...
    return function() {
        ...
        var d = {
            ...
            prefix: ("undefined" != typeof window && document.documentElement ? getComputedStyle(document.documentElement).getPropertyValue("--prefix").trim() : ""),
            ...
            scrollPageTo: function(e) {
                ...
                var o = n.scrollTop,
                    ...
                    r = +new Date,
                    a = function() {
                        var s, u, l, c = +new Date - r,
                            d = (s = c, u = o, l = i, (s /= t / 2) < 1 ? l / 2 * s * s + u : -l / 2 * ((s -= 1) * (s - 2) - 1) + u);
            ...
            showActiveTheme: function(e) {
                ...
                if (n) {
                    ...
                    // Defensive: check if r exists before using it
                    if (!r) return;
                    var a = r.querySelector("i");
                    if (!a) return;
                    var s = a.getAttribute("data-icon");
                    ...
                    var u = Array.from(i.classList).filter((function(e) {
                        return !e.startsWith("ri-")
                    }));
                    i.setAttribute("class", "ri-".concat(s, " ").concat(u.join(" ")));
                    var l = "".concat(o.textContent, " (").concat(r.dataset.bsThemeValue, ")");
                    n.setAttribute("aria-label", l), t && n.focus()
                }
            },
            ...
            initPasswordToggle: function() {
                ...
                null != e && e.forEach((function(e) {
                    e.addEventListener("click", (function(t) {
                        ...
                        "text" === i.getAttribute("type") ? (i.setAttribute("type", "password"), o.classList.replace("ri-eye-line", "ri-eye-off-line")) : "password" === i.getAttribute("type") && (i.setAttribute("type", "text"), o.classList.replace("ri-eye-off-line", "ri-eye-line"))
                    }))
                }))
            },
